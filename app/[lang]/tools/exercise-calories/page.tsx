...
import { EXERCISE_CAL_LABELS, type ToolLang } from '@/lib/tool-labels';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const L = EXERCISE_CAL_LABELS[params.lang as ToolLang];
  return {
    title: `${L.pageTitle} — HAVIT`,
    description: L.pageIntro,
    alternates: {
      canonical: `https://blog.aihavit.com/${params.lang}/tools/exercise-calories`,
      languages: Object.fromEntries(ROUTE_LANGS.map((l) => [l, `https://blog.aihavit.com/${l}/tools/exercise-calories`])),
    },
    openGraph: { title: L.pageTitle, description: L.pageIntro, type: 'website', url: `https://blog.aihavit.com/${params.lang}/tools/exercise-calories` },
  };
}
