...
import { SLEEP_CYCLE_LABELS, type ToolLang, toToolLang } from '@/lib/tool-labels';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const L = SLEEP_CYCLE_LABELS[toToolLang(params.lang)];
  return {
    title: `${L.pageTitle} — HAVIT`,
    description: L.pageIntro,
    alternates: {
      canonical: `https://blog.aihavit.com/${params.lang}/tools/sleep-cycle`,
      languages: Object.fromEntries(ROUTE_LANGS.map((l) => [l, `https://blog.aihavit.com/${l}/tools/sleep-cycle`])),
    },
    openGraph: { title: L.pageTitle, description: L.pageIntro, type: 'website', url: `https://blog.aihavit.com/${params.lang}/tools/sleep-cycle` },
  };
}

export default function SleepCyclePage({ params }: Props) {
  ...
  const L = SLEEP_CYCLE_LABELS[lang];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 mx-auto max-w-3xl w-full px-4 md:px-6 py-8 md:py-12">
        ...
        <SleepCycleCalculator labels={L} lang={lang} />
