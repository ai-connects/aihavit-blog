...
import { WATER_LABELS, type ToolLang, toToolLang } from '@/lib/tool-labels';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const L = WATER_LABELS[toToolLang(params.lang)];
  return {
    title: `${L.pageTitle} — HAVIT`,
    description: L.pageIntro,
    alternates: {
      canonical: `https://blog.aihavit.com/${params.lang}/tools/water`,
      languages: Object.fromEntries(ROUTE_LANGS.map((l) => [l, `https://blog.aihavit.com/${l}/tools/water`])),
    },
    openGraph: { title: L.pageTitle, description: L.pageIntro, type: 'website', url: `https://blog.aihavit.com/${params.lang}/tools/water` },
  };
}

export default function WaterPage({ params }: Props) {
