...
const TOOLS: Tool[] = [
  ...
  { slug: 'protein', emoji: '🥚', ready: true, title: { ko: '단백질 필요량', en: 'Protein Needs', ja: 'たんぱく質必要量', zh: '蛋白质需求', 'zh-tw': '蛋白質需求', es: 'Necesidad de Proteína' }, desc: { ko: '체중·목표·연령별 일일 단백질 g.', en: 'Daily protein g by weight, goal, age.', ja: '体重・目標・年齢別の1日たんぱく質g。', zh: '按体重、目标、年龄计算每日蛋白质克数。', 'zh-tw': '按體重、目標、年齡計算每日蛋白質克數。', es: 'Gramos diarios de proteína por peso, objetivo y edad.' } },
  { slug: 'water', emoji: '💧', ready: true, title: { ko: '수분 섭취량', en: 'Water Intake', ja: '水分摂取量', zh: '水分摄入量', 'zh-tw': '水分攝取量', es: 'Hidratación' }, desc: { ko: '체중·활동·기후 기반 일일 수분.', en: 'Daily water by weight, activity, climate.', ja: '体重・活動・気候別の1日水分。', zh: '基于体重、活动、气候的每日水分。', 'zh-tw': '基於體重、活動、氣候的每日水分。', es: 'Agua diaria por peso, actividad y clima.' } },
  ...
  { slug: 'sleep-cycle', emoji: '😴', ready: true, title: { ko: '수면 사이클', en: 'Sleep Cycle', ja: '睡眠サイクル', zh: '睡眠周期', 'zh-tw': '睡眠週期', es: 'Ciclo de Sueño' }, desc: { ko: '6:30에 일어나려면 몇 시에 자야?', en: 'To wake at 6:30, what time to sleep?', ja: '6:30に起きるには何時に寝る?', zh: '6:30 起床该几点睡?', 'zh-tw': '6:30 起床該幾點睡?', es: '¿A qué hora dormir para despertar a las 6:30?' } },
  { slug: 'exercise-calories', emoji: '💪', ready: true, title: { ko: '운동 칼로리 소모', en: 'Exercise Calorie Burn', ja: '運動カロリー消費', zh: '运动卡路里消耗', 'zh-tw': '運動卡路里消耗', es: 'Calorías por Ejercicio' }, desc: { ko: 'METs 기반 운동별 정확한 칼로리.', en: 'METs-based accurate burn by activity.', ja: 'MET基準で運動別の正確なカロリー。', zh: '基于MET的运动卡路里精确计算。', 'zh-tw': '基於MET的運動卡路里精確計算。', es: 'Quema precisa por actividad basada en METs.' } },
];
