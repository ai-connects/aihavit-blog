...
export default function AppCtaBanner({ lang }: { lang: ToolLang }) {
  ...
  return (
    <div className="mt-6 p-5 rounded-2xl border-2 border-primary-500 bg-primary-50 dark:bg-primary-900/20">
      <div className="font-bold text-base mb-1.5">{t.title}</div>
      <p className="text-sm text-gray-700 dark:text-gray-300 mb-3 leading-relaxed">{t.body}</p>
